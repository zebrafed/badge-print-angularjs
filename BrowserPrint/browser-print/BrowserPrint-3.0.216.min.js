...
var BrowserPrint = (function () {
  ...
  e.Device = function (a) {
    ...
    this.send = function (d, a, f) {
      ...
      g &&
        (void 0 !== m &&
          (void 0 === a && (a = m.sendFinishedCallback),
          void 0 === f && (f = m.sendErrorCallback)),
        c(g, a, f),
        g.send(
          JSON.stringify({
            device: {
    ...
    this.read = function (d, a) {
      ...
      f &&
        (void 0 !== m &&
          (void 0 === d && (d = m.readFinishedCallback),
          void 0 === a && (a = m.readErrorCallback)),
        c(f, d, a),
        f.send(
          JSON.stringify({
            device: {
    ...
    this.readUntilStringReceived = function (d, a, b, e, c) {
      ...
      a = (function (a, b, e, f, g) {
        return function (c) {
          ...
          "" !== d && -1 < c.indexOf(d)
            ? b(c)
            : a.readUntilStringReceived(d, b, e, f - 1, c);
        };
      })(this, a, b, e, c);
      this.read(a, b);
    };
      ...
      ((finishedFunction = function (b) {
        ...
        for (var c in response)
          if (response.hasOwnProperty(c) && response[c].constructor === Array)
            for (arr = response[c], b = 0; b < arr.length; ++b)
