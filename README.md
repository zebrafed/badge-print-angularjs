...
app/                  --> all of the source files for the application
  ...
  paper-badge/                --> the paper-badge view template and logic
    paper-badge.html            --> the partial template
    paper-badge.js              --> the controller logic
    paper-badge_test.js         --> tests of the controller
